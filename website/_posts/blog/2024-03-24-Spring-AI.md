...
framwork will intercept a tool invocation request & call the appropriate method defined in the callback.
...
production ready Agent. All the code will be available on my [GitHub](https://github.com/johnsosoka/code-examples/tree/main/java/spring-ai-booking)
...
get stuck in a loop requesting the 1st page.
